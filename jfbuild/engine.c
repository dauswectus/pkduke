...
long xb1[MAXWALLSB];
static long yb1[MAXWALLSB], xb2[MAXWALLSB], yb2[MAXWALLSB];
long rx1[MAXWALLSB], ry1[MAXWALLSB];
static long rx2[MAXWALLSB], ry2[MAXWALLSB];
short p2[MAXWALLSB];
...
long r_usenewaspect = 0;

void setaspect_new() {
    float xfov;
    float k = (xdim/(float)ydim)/1.33333333;

    if (r_usenewaspect) {
        //
        
        setaspect(65536, divscale16(ydim*320, xdim*200/k));
